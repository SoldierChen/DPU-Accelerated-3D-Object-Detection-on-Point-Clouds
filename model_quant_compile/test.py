...
def parse_test_configs():
    ...
    if configs.save_test_output:
        configs.results_dir = os.path.join(configs.root_dir, 'results_resnet', configs.saved_fn)
...
if __name__ == '__main__':
    ...
    #torch.device('cpu' if configs.no_cuda else 'cuda:{}'.format(configs.gpu_idx))
